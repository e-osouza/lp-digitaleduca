      ...
      <div className="bg-[var(--primary)] bg-[url(/bannerSuperior.png)] bg-top py-40">
        <div className="max-w-[var(--largura)] mx-auto px-5">
          <div className="max-w-[500px] mx-auto">
            <h1 className="text-white text-center text-5xl/13 font-extrabold">Se especialize em <span className="block text-[#efcf6b]">Marketing ,Vendas, Empreendedorismo e Inovação</span></h1>
